        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
                <div class="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                    {{-- Path gambar diperbarui sesuai screenshot Anda --}}
                    <img src="{{ asset('images/picture.png') }}" alt="Our Story" class="w-full h-auto object-cover">
                </div>
    ...
    <div class="container">
        ...
        <div class="grid md:grid-cols-1 gap-8 max-w-lg mx-auto">
            ...
            <div class="group text-center">
                <h3 class="text-xl font-bold text-dark-text mb-1">Samuel Indra Bastian</h3>
                <p class="text-primary-600 font-semibold mb-3">Web Developer</p>
                <p class="text-gray-600 text-sm mb-4">
                    Melayani dengan sepenuh hati dalam pengembangan dan inovasi.
                </p>
